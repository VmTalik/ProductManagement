...
@router.patch("/{id}", response_model=ProductUpdateResponse, status_code=status.HTTP_200_OK)
async def update_product_field(
    ...
    return await product_repo.update_product_field(product_id=id, product_field_update=product_field_update)
